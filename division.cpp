...
carry=0;
if (!flag) {
divisor=(rhand-lhand)/2;  //���� ������
}
if (flag) {
divisor=(rhand-lhand)/2+lhand; //���� ������
}
...
j=offset-(deg-1);
offset-=((deg-deg_chas)+(deg_chas-deg_rem));   //��������� ��������� ������� ����-�� number1
...
if (temp.size() == TEMP.count2) 
{
	...
	for (i=TEMP.count2-1; i>=0; i--) {
		if (int(TEMP.number2[i])-48 < int(temp[i])-48) { //���� temp > number2
			i=-10;
			rem.clear();
			del.clear();
			del=temp;
